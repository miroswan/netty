...
import io.netty.ffm.macos.generated.Posix;
...
public final class FileIO {
    ...
    public static boolean isInterrupted(final long packedResultAndErrno) {
        return ErrnoState.unpackResult(packedResultAndErrno) < 0 && ErrnoState.unpackErrno(packedResultAndErrno) == Errno.EINTR();
    }
